    ...
    <View>
      <View
        ...
        <TouchableOpacity
          ...
          <Text
            style={{
              color: getSelectionMode == 1 ? 'white' : selectionColor, fontFamily: Fonts.OpenSans500Medium,
            }}>
            {option1}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <Text
            style={{
              color: getSelectionMode == 2 ? 'white' : selectionColor, fontFamily: Fonts.OpenSans500Medium,
            }}>
            {option2}
          </Text>
        </TouchableOpacity>
