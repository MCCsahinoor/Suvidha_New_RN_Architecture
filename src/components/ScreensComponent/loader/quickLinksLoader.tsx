...
const QuickLinksLoader: FC<any> = () => {

    return (
        <View style={{ width: "100%", paddingHorizontal: 0, display: 'flex', flexDirection: 'row', gap: 5, justifyContent: 'space-between', flexWrap: 'wrap' }}>
            <View style={{ width: '48%' }}><DynamicShimmerPlaceholder borderRadius={5} height={100} width={"100%"} count={1} /></View>
            <View style={{ width: '48%' }}><DynamicShimmerPlaceholder borderRadius={5} height={100} width={"100%"} count={1} /></View>
            <View style={{ width: '48%' }}><DynamicShimmerPlaceholder borderRadius={5} height={100} width={"100%"} count={1} /></View>
            <View style={{ width: '48%' }}><DynamicShimmerPlaceholder borderRadius={5} height={100} width={"100%"} count={1} /></View>
            <View style={{ width: '48%' }}><DynamicShimmerPlaceholder borderRadius={5} height={100} width={"100%"} count={1} /></View>
...
export default QuickLinksLoader;