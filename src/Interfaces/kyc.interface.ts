...
export interface I_IDPROOF_kycPayload {
  doc_id: string;
  doc_path: string;
...
export interface I_KYC_BANK_FormData {
  ifsc_code: string;
  bank_name: string;
  branch_name: string;
  hdn_acc_no: string;
...
export module I_REDUX_KYC_DATA {
  export interface REDUX_KYC_DATA {
...
export module I_SUBMIT_USER_KYC {
  export interface KYC_DATA {
    ...
    app: string;
    wa_ph_no: string;
    painter_documents: PainterDocument[] | null;
  }
...
export interface I_RESPONSE_KYC_SUBMIT {
