...
interface consistencyBonusDetailsProps {
    consistencyBonusDetails: any;
    openRewardModal?: (trip: any) => void;
}

const ConsistencyBonus: React.FC<consistencyBonusDetailsProps> = ({ consistencyBonusDetails, openRewardModal }) => {
            ...
            <DataTable>
                ...
                <DataTable.Row style={{
                    ...
                    <DataTable.Cell style={{ flex: 2 }} textStyle={styles.colTitle}>
                        {consistencyBonusDetails.target_points != 0 ? formatNumberWithCommas(consistencyBonusDetails.target_points) : '-'}
                    </DataTable.Cell>
                    <DataTable.Cell style={{ flex: 2 }} textStyle={styles.colTitle}>
                        {consistencyBonusDetails.actual_points != 0 ? formatNumberWithCommas(consistencyBonusDetails.actual_points) : '-'}
                    </DataTable.Cell>
                    <DataTable.Cell style={{ flex: 2 }} textStyle={styles.colTitle}>
                        {((consistencyBonusDetails.pending_points < 0 || consistencyBonusDetails.pending_points == 0) ? '-' : formatNumberWithCommas(consistencyBonusDetails.pending_points)) || '-'}
                    </DataTable.Cell>
                    <DataTable.Cell style={{ flex: 2 }} textStyle={styles.colTitle}>
                        {consistencyBonusDetails.reward_value != 0 ? formatNumberWithCommas(consistencyBonusDetails.reward_value) : '-'}
                    </DataTable.Cell>
                </DataTable.Row>
...
export default ConsistencyBonus;
